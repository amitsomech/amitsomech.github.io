...
const SITE_DATA = {
  ...
  // ABOUT
  // ----------------
  about: `Hi! I am an Assistant Professor (Senior Lecturer) at the <a href="https://cs.biu.ac.il/" target="_blank" class="text-primary-600 hover:underline">Computer Science Department</a> at <a href="https://www.biu.ac.il/" target="_blank" class="text-primary-600 hover:underline">Bar-Ilan University</a>. <br><br> My research focuses on building autonomous analytical agents for exploring, analyzing, and explaining tabular data. I am particularly interested in studying the capabilities and limitations of large language models in the context of structured data, and in developing principled methods that bridge statistical analysis, data management, and AI.
  <br><br>
